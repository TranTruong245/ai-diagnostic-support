    ...
    <div className='relative flex flex-col'>
      ...
      <div className='ml-[103px] mt-[90px] z-10'>
        <div  className='flex items-center w-[650px] h-[120px] my-[40px] bg-white rounded-3xl shadow border-2 border-red-500' >
          ...
          <input type="text" placeholder="Tài khoản" style={{width:"500px", height:"80px",fontSize:"25px",outline:"none"}}  />
        </div>
        ...
        <div className='flex items-center w-[650px] h-[120px]  bg-white rounded-3xl shadow border-2 border-red-500 z-10'>
          ...
          <input
            ...
            style={{ width: '500px', height: '80px', fontSize: '25px', border: 0, outline: 'none' }}
          />
        ...
        <div className='ml-[144px]'>
          ...
          <div className="mt-8 ml-20 mb-[211px] text-black text-xl font-extralight underline">Quên mật khẩu - Hỗ trợ</div>
        </div>
      </div>
