  ...
  return (
    <div className="relative flex flex-col">
      ...
      <div className="ml-[103px] mt-[90px] z-10">
        <div className="flex items-center w-[40%] h-[120px] my-[40px] bg-white rounded-3xl shadow border-2 border-red-500">
          <div className="mx-2">
        ...
        <div className="flex items-center w-[40%] h-[120px]  bg-white rounded-3xl shadow border-2 border-red-500 z-10">
          <div className="mx-2">
          ...
          <div onClick={togglePasswordVisibility}>
            {showPassword ? (
              <VisibilityOffIcon sx={{ fontSize: 45 }} />
            ) : (
              <VisibilityIcon sx={{ fontSize: 45 }} />
            )}
          </div>
        ...
        <div className="ml-[144px]">
          ...
          <div className="mt-8 ml-20 mb-[211px] text-black text-xl ">
